...
public class MyBoardUIJoin extends JFrame {
    ...
    public MyBoardUIJoin(GameClient client, String playerName) {
                    ...
                    cell.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            ...
                            if (cellHasShip(row, col) && placedShipCount > 0) {
                                ...
                                JOptionPane.showMessageDialog(null, "This cell is not part of a ship.");
                            }
                        }
                    });
                }
        ...
        joinGameButton.addActionListener(e -> {
            if (placedShipCount >= 5) {
                dispose();
                SwingUtilities.invokeLater(() -> new JoinGameScreen(client, playerName));
            } else {
